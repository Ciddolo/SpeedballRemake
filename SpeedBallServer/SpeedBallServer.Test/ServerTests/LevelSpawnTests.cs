...
namespace SpeedBallServer.Test.ServerTests
{
    class LevelSpawnTests
    {
        ...
        public void SetUpTest()
        {
            ...
            string level = File.ReadAllText(TestContext.CurrentContext.TestDirectory + "\\TestData\\BumpersTestLevel.json");
        ...
        {
            Assert.That(server.GameObjectsAmount, Is.EqualTo(31));
        }
